...
- <b>crazy drivers, unlearnable behaviour?</b> with the way folks drive in shenzhen + traffic rules (more likely not followed than followed), it feels too "unpredictable" for an automated system to navigate
- <b>protecting workers:</b> even if successful, the government may not be extremely open to mass deployment as it takes economic jobs in an already high unemployment market. [3, 5, 6]
- <b>chinese autonomous vehicle market</b>: with baidu's apollo go, weride, pony ai, all in testing phase but on international roads: singapore, abu dhabi, dubai. why not chinese roads? too difficult to learn, or additional regulations? [2]

other robot things:
- <b>humanoid vs non-humanoid</b>: make humanoid robots as most of society is shaped by the human form. but it's inefficient. why build a humanoid robot to drive a car when you can just build a self-driving car?
- <b>imo china will just dominate</b>. anything that requires hardware and materials, china just has such a strong competitive advantage with the manufacturing base.
`,
